...
void MainWindow::currentBlock(QPainter *qp) {
    ...
    state=L(qp, &current_Y,key_state);
    if (state){
...
bool MainWindow::T(QPainter *qp,uint16_t y, state_t key_state)
{
    uint16_t x=0;
    qDebug() << key_state;
...
bool MainWindow::Q(QPainter *qp, uint16_t y, state_t key_state)
{
...
bool MainWindow::I(QPainter *qp, uint16_t y, state_t key_state)
{
    static uint16_t x=SIZE_AREA_X/2;
    static angle_t rotate=ANGLE_0;
    bool state=false;
...
bool MainWindow::Z(QPainter *qp, uint16_t y, state_t key_state)
{
    static uint16_t x=SIZE_AREA_X/2;
    static angle_t rotate=ANGLE_0;
    bool state=false;
...
bool MainWindow::S(QPainter *qp,uint16_t y, state_t key_state)
{
    static uint16_t x=SIZE_AREA_X/2;
    static angle_t rotate=ANGLE_0;
    bool state=false;
...
bool MainWindow::L(QPainter *qp,uint16_t *y, state_t key_state)
{
